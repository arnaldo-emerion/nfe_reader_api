...
import br.com.asoft.nfereader.model.TotalRecordsDTO
...
class UserConfigurationController(
    ...
    override fun getEstatiticasUtilizacao(): ResponseEntity<TotalRecordsDTO> {
        val count = this.documentoFiscalService.countByUserCreate(securityUtil.getIdentityId())
        return ResponseEntity.ok(count.toDto())
    }
}